...
<div class="container">
    <div class="top-nav relative mt-3 flex justify-between">
        <div class="back">
            <a href="<?php echo auth_url('login') ?>"
    ...
    <?php endif; ?>
    <form action="<?php echo auth_url('register') ?>" name="loginForm"
        class="py-6 flex flex-col gap-4 md:w-[70%] mx-auto" method="post">

        <form action="<?php echo auth_url('register') ?>" name="loginForm"
            class="py-6 flex flex-col gap-4 md:w-[70%] mx-auto" method="post">

            <input class="px-3" type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">

            <!-- Email Field -->
            <div class="fieldset">
                <div class="field email">
                    <input class="px-3" type="text" name="email" id="email" class=""
                        placeholder="<?php echo Flang::_e('plc_email') ?>" required="">
                </div>
            </div>
            ...
            <div class="fieldset">
                <div class="field fullname">
                    <input class="px-3" type="text" name="fullname" id="fullname" class=""
                        placeholder="<?php echo Flang::_e('plc_fullname') ?>" required="">
            ...
            <div class="fieldset">
                <div class="field username">
                    <input class="px-3" type="text" name="username" id="username" class=""
                        placeholder="<?php echo Flang::_e('plc_username') ?>" required="">
                </div>
            </div>
            ...
            <div x-data="{ showPassword: false }" class="fieldset">
                <div class="field password">
                    <input class="px-3" :type="showPassword ? 'text' : 'password'" name="password" id="password"
                        placeholder="<?php echo Flang::_e('plc_password') ?>" class="" required="">
            ...
            <div x-data="{ showPassword: false }" class="fieldset">
                <div class="field confirm-password">
                    <input class="px-3" :type="showPassword ? 'text' : 'password'" name="confirm-password"
                        id="confirm-password" placeholder="<?php echo Flang::_e('plc_re_password') ?>" class=""
                        required="">
                    <span @click="showPassword = !showPassword"
                        class="absolute inset-y-0 right-0 px-3 py-2 flex items-center text-gray-600 focus:outline-none cursor-pointer"
                        :class="{'text-gray-600': !showPassword, 'text-white': showPassword}">
            ...
            <div class="fieldset flex flex-col gap-4">
                <div class="action flex justify-center">
                    <button type="submit" class="btn btn-primary rounded-full">
                        <?php echo Flang::_e('submit_request') ?>
                    </button>
                </div>
            </div>
            <div class="my-4 flex items-center gap-4">
                <hr class="w-full border-grey">
                <p class="text-sm text-gray-500 text-center"><?php echo Flang::_e('or') ?></p>
                <hr class="w-full border-grey">
            </div>
            <div class="social">
...
<?php Render::block('footer', ['layout' => 'default']);
?>
