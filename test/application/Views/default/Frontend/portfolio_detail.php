                                        ...
                                        <div class="featured-carousel owl-carousel">
                                            ...
                                            <?php for($i = 1; $i <= 12; $i++): ?>
                                                <?php if($item['img' . $i] != ''):?>
                                                    <div class="item">
                                                        <div class="work">
                                                            <a href="<?= '/uploads/' . $cate . '/' . $item['folder_name'] . '/' . $item['img' . $i]; ?>" style="background-image: url('<?= '/uploads/' . $cate . '/' . $item['folder_name'] . '/' . $item['img' . $i]; ?>');" class="img d-flex align-items-center justify-content-center fancybox" data-fancybox="yca-logo">
                                                            </a>
                                                        </div>
                                                    </div>
                                                <?php endif;?>
                                            ...
                                            <ul class="thumbnail carousel-caption">
                                                <?php for($i = 1; $i <= 12; $i++): ?>
                                                    ...
                                                    <li class="active img">
                                                        ...
                                                        <a href="<?= '/uploads/' . $cate . '/' . $item['folder_name'] . '/' . $item['img' . $i]; ?>">
                                                            <img src="<?= '/uploads/' . $cate . '/' . $item['folder_name'] . '/' . $item['img' . $i]; ?>" class="img-fluid">
                                                        </a>
                                                    </li>
                                                    <?php endif;?>
                                                <?php endfor;?>
                                                ...
                                                <div class="relative">
                                                    <div class="thumb portfolio-item">
                                                        ...
                                                        <a class="portfolio-link" href="<?= base_url('/detail/' . create_slug($related['name']) . '/' . $related['id']); ?>">
                                                            <img class="img-fluid" src="<?= '/uploads/' . $cate . '/' . $related['folder_name'] . '/' . $related['img_background']; ?>" alt="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="p-inner">
