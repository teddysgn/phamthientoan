...
return [
    // Cấu hình ứng dụng
    'app' => [
        'debug' => true, //Khai bao true neu muon dua ve che do development
    ...
    'db' => [
        ...
        'db_driver' => 'mysql',
        'db_host' => '31.170.164.153',
        'db_port' => 3306,
        'db_username' => 'u134300833_portfoilio',
        'db_password' => 'Phamthientoan2024@gmail.com',
        'db_database' => 'u134300833_portfoilio',
        'db_charset'  => 'utf8mb4',
