                                 ...
                                 <tbody id="result-ajax">
                                    ...
                                    <?php foreach($items['data'] as $item): ?>
                                        <tr>
                                            ...
                                            <td><img width="180" loading="lazy" src="<?= option('upload_folder') . 'clients/' . $item['img']?>" alt=""></td>
                                            <td><?= $item['style']; ?></td>
                                            <td><?= $item['id']; ?></td>
                                            <td>
                                                <a href="<?= auth_url($slug . '/delete/' . $item['id'])?>" onclick="return confirm('Do you want to delete this client?');" class="btn btn-sm btn-danger btn-delete py-2">
