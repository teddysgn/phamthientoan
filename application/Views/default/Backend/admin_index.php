                              ...
                              <table class="table tablesorter " id="">
                                    ...
                                    <?php foreach($items['data'] as $item): ?>
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td><img width="180" loading="lazy" src="<?= option('upload_folder') . $cate . '/' . $item['folder_name'] . '/' . $item['img_background']?>" alt=""></td>
                                            <td><?= $category; ?></td>
                                            <td><a href="<?= auth_url($slug . '/status/' . $item['status'] . '/' . $item['id'])?>" class="btn btn-sm btn-<?= $item['status'] == 'active' ? 'success' : 'danger';?> text-white"><?= $item['status']; ?></a></td>
                                            <td><?= $item['ordering']; ?></td>
                                            <td><?= $item['date_inside']; ?></td>
                                            <td><?= $item['view']; ?></td>
                                            <td><?= $item['id']; ?></td>
                                            <td>
                                                <a href="<?= auth_url($slug . '/delete/' . $item['id'])?>" onclick="return confirm('Do you want to delete this project?');" class="btn btn-sm btn-danger btn-delete py-2">
                                 ...
                                 <div class="row">
                                             ...
                                             <div class="col-sm-12 col-md-12">
                                                <li class="dropdown nav-item" style="list-style-type: none; margin: 4px 1px">
                                                   ...
                                                   <ul class="dropdown-menu">
                                                      <li class="nav-link">
                                                         <a style="color: #800020" href="<?= auth_url($slug); ?>?<?= $keyword != null ? 'keyword=' . $keyword . '&' : '';?>category_id=0" class="nav-item dropdown-item p-0 ">Show All Projects</a>
                                                      </li>
                                                      <?php foreach($categories as $category => $value):?>
                                                         <li class="nav-link">
                                                            <a style="color: #800020" href="<?= auth_url($slug); ?>?<?= $keyword != null ? 'keyword=' . $keyword . '&' : '';?>category_id=<?= $value['id']?>" class="nav-item dropdown-item p-0 "><?= $value['name']?></a>
                                                         </li>
                                                      <?php endforeach;?>
                                                   </ul>
                                                </li>
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                       <form method="GET" action="<?= auth_url($slug); ?><?= $category_id != null ? '?category_id=' . $category_id : '';?>">
                                          <div class="row">
                                             <div class="col-sm-12 col-md-8">
                                                <div class="form-group" style="margin: 4px 1px">
                                                   <input type="text" class="form-control search" style="position: relative" id="search_input" name="keyword" value="<?= $keyword?>" placeholder="Search..." style="color: #800020; font-size: 17px">
                                                  
                                                </div>
                                             </div>
                                             <div class="col-sm-12 col-md-4">
                                                <button id="btn-search" style="padding: 10px 18px" href="http://localhost/admin/products?filter_status=all" class="btn btn-sm btn-warning">
                                                   Search</button>
                                             </div>
                                             <div class="col-sm-12 col-md-12">
