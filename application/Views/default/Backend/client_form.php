...
<html lang="en">
   ...
   <body class="">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" id="style" name="style" class="form-control"
                                          placeholder="Style" value="<?= $item['style']; ?>">
                     ...
                     <div class="col-md-8">
                        <div class="card card-user">
                           <div class="card-body ">
                              ...
                              <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?php if($item['img'] != ''):?>
                                                <img id="display_image" style="background-color: floralwhite" src="<?= option('upload_folder') . 'clients/' . $item['img']?>" alt="<?= $item['name']; ?>">
                                            <?php else: ?>
                                                <img id="display_image" style="background-color: floralwhite" src="<?= option('upload_folder') . 'default/default.png'; ?>" alt="default">
                                            <?php endif;?>
                                        </div>
                                    </div>
                              </div>
                           ...
                           <div class="card-footer row text-center justify-content-center">
                                ...
                                <?php for($i = 1; $i <= 12; $i++): ?>
                                    <?php if($item['img' . $i] != ''):?>
                                        <input type="hidden" name="hidden_picture" value="<?= $item['img' . $i]; ?>">
                                    <?php endif;?>
                                <?php endfor;?>
      ...
      <script>
         var element = document.getElementById('clients').className = 'active';
      </script>
   </body>
</html>
<?= Session::del('success');?>