    ...
    <div class="container">
        <div class="row mb-5 align-items-center">
            <div class="col-lg-7 pr-lg-5 mb-lg-0" data-aos="fade-right">
                <img src="<?= option('upload_folder'); ?>about/avatar.jpg" alt="Image placeholder" class="img-fluid">
            </div>
...
<div #swiperRef="" class="swiper mySwiper text-center" style="padding: 10px 0 30px">
    <div class="swiper-wrapper" style="align-items: center">
        <?php foreach($clientsList as $client):?>
            <div class="swiper-slide" style="margin: 10px; display: flex; <?= $client['style'] != '' ? $client['style'] : ''?>"><img src="<?= option('upload_folder'); ?>clients/<?= $client['img']?>" alt="" ></div>
        <?php endforeach; ?>
    </div>
  </div>
