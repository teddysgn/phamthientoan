...
<style>
    ...
    .ms--images .ms-slide:nth-child(1) .ms-slide__image {
        background-image: url("<?= option('upload_folder'); ?>rectangle/01.jpg");
        background-repeat: round;
    }

    .ms--images .ms-slide:nth-child(2) .ms-slide__image {
        background-image: url("<?= option('upload_folder'); ?>rectangle/02.jpg");
        background-repeat: round;
    }

    .ms--images .ms-slide:nth-child(3) .ms-slide__image {
        background-repeat: round;
        background-image: url("<?= option('upload_folder'); ?>rectangle/03.jpg");
    }

    .ms--images .ms-slide:nth-child(4) .ms-slide__image {
        background-repeat: round;
        background-image: url("<?= option('upload_folder'); ?>rectangle/04.jpg");
    }

    .ms--images .ms-slide:nth-child(5) .ms-slide__image {
        background-repeat: round;
        background-image: url("<?= option('upload_folder'); ?>rectangle/05.jpg");
    }

    .ms--images .ms-slide:nth-child(6) .ms-slide__image {
        background-repeat: round;
        background-image: url("<?= option('upload_folder'); ?>rectangle/06.jpg");
    }
    ...
    @media screen and (max-width: 415px) {
        ...
        .ms--images .ms-slide:nth-child(1) .ms-slide__image {
            background-image: url("<?= option('upload_folder'); ?>square/01.jpg") !important;
            background-repeat: space;
            background-size: contain;
        }
        .ms--images .ms-slide:nth-child(2) .ms-slide__image {
            background-image: url("<?= option('upload_folder'); ?>square/02.jpg") !important;
            background-repeat: space;
            background-size: contain;
        }
        ...
        .ms--images .ms-slide:nth-child(3) .ms-slide__image {
            background-repeat: space;
            background-size: contain;
            background-image: url("<?= option('upload_folder'); ?>square/03.jpg") !important;
        }

        .ms--images .ms-slide:nth-child(4) .ms-slide__image {
            background-repeat: space;
            background-size: contain;
            background-image: url("<?= option('upload_folder'); ?>square/04.jpg") !important;
        }

        .ms--images .ms-slide:nth-child(5) .ms-slide__image {
            background-repeat: space;
            background-size: contain;
            background-image: url("<?= option('upload_folder'); ?>square/05.jpg") !important;
        }

        .ms--images .ms-slide:nth-child(6) .ms-slide__image {
            background-repeat: space;
            background-size: contain;
            background-image: url("<?= option('upload_folder'); ?>square/06.jpg") !important;
        }
        .pagination {
            top: calc(100% - 70px);
        }
