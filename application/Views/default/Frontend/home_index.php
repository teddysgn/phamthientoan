...
<!-- ======= Hero Section ======= -->
<section id="hero" class="page site-hero d-flex flex-column justify-content-center align-items-center" style="background-image: url('<?= option('upload_folder'); ?>background/background.jpg'); background-attachment: unset; background-size: cover; background-position: bottom;">
